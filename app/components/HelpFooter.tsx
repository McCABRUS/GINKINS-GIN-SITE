export default function HelpFooter() {
  return (
    <>
      ...
      <div
        className="absolute border-solid border-(--primary-red-main) border-t border-r-0 border-b-0 border-l-0 shrink-0 w-18.75 h-0 z-20 bottom-75 md:bottom-62.5 lg:bottom-88.25 left-1/2 -translate-x-1/2"
        style={{
