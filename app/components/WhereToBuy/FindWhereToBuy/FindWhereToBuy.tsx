...
export default function FindWhereToBuy() {
  return (
    <section className="bg-(--primary-black) text-background pb-30 lg:pb-16 w-screen pt-25 relative overflow-hidden">
      ...
      ></div>
      <div className="hidden lg:block absolute border-solid border-(--primary-gold-main) border-t border-r-0 border-b-0 border-l-0 shrink-0 w-50 2xl:w-[40%] lg:w-[30%] h-0 z-20 top-1/2 left-25 2xl:left-[15%] xl:left-[10%] lg:left-[15%] -translate-x-1/2"></div>
      <div className="hidden lg:block absolute border-solid border-(--primary-gold-main) border-t border-r-0 border-b-0 border-l-0 shrink-0 w-50 2xl:w-[40%] lg:w-[30%] h-0 z-20 top-1/2 -right-25 2xl:-right-[25%] xl:-right-[20%] lg:-right-[15%] -translate-x-1/2"></div>
    </section>
  );
}
