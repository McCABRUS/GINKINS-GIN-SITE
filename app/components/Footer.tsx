    ...
    <footer className="bg-(--primary-black) text-background">
      <div className="mx-auto max-xl:px-5 max-4xl:px-37.25 md:max-w-480 py-12">
        <div className="xl:hidden flex flex-col items-center text-center">
          ...
          <p className="text-sm text-(--secondary-gray-300) mb-6">
          ...
          <div className="border-t border-(--primary-red-main) mt-6.25 pt-6">
            <div className="flex flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 text-sm">
                <Link
                  href="/privacy"
                  className="hover:text-(--primary-red-main) active:text-(--primary-red-main) focus:text-(--primary-red-main) text-(--secondary-gray-300)"
                >
                  Privacy Policy
                </Link>
