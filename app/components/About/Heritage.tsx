...
export default function Heritage() {
  return (
    <section className="w-screen bg-(--secundary-beige) relative">
      <HeritageInnovation />
      <div className="w-full bg-(--primary-red-main) ">
        <div className="bg-(--primary-red-main) max-h-50 mx-auto max-x-full relative grid grid-cols-2  max-x-full md:max-w-350 px-6">
          <h4 className="text-background! justify-self-start self-start text-left">
          ...
          <Image
            ...
            className="w-142.25 h-202.5 justify-self-end self-end object-cover"
            height={810}
            width={569}
          />
        </div>
      ...
      <div className="mx-auto max-x-full md:max-w-350 px-6px-6 py-24 grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
        ...
        <div className="space-y-6">
          ...
          <p className="text-(--primary-red-main) text-4xl font-cormorant-garamond font-medium">
      ...
      <div
        className="absolute border-solid border-(--primary-black) border-t border-r-0 border-b-0 border-l-0 shrink-0 w-26.75 h-0 z-20 top-13.25 left-1/2 -translate-x-1/2"
        style={{
