...
export default function Heritage() {
  return (
    <section className="w-screen bg-(--secondary-beige) relative">
      ...
      <div className="mx-auto max-x-full md:max-w-350 px-5 py-24 grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
      ...
      <div
        className="absolute border-solid border-(--primary-black) border-t border-r-0 border-b-0 border-l-0 shrink-0 w-16.75 md:w-26.75 h-0 z-20 top-8.25 md:top-13.25 left-1/2 -translate-x-1/2"
        style={{
