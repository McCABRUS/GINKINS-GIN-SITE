...
export default function WelcomeHome() {
  return (
    <section className="bg-(--primary-red-main) flex w-full h-51.25 flex-col justify-center items-center gap-2.5 lg:-mt-101 xl:mt-0">
      <div className="flex flex-wrap flex-row justify-between items-center content-center w-[80%]  md:w-160.75 h-16.5 bg-[url(/WelcomeContainer/welcomeContainer.svg)] bg-contain bg-center bg-no-repeat ">
        <div>
          <Image
