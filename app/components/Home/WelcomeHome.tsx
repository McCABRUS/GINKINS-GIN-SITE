...
export default function WelcomeHome() {
  return (
    <section className="bg-(--primary-red-main) flex w-full h-51.25 flex-col justify-center items-center lg:-mt-101 xl:mt-0 mt-3.5">
      <div className="flex flex-wrap flex-row justify-between items-center content-center w-[80%] h-6.75 lg:h-13.25 max-w-480 reveal-on-load-center">
        ...
        <Image
          ...
          aria-hidden
        />
        <h2 className="text-center text-background! text-xl! 2xs:text-2xl! xs:text-3xl! md:text-[32px]! lg:text-4xl! z-10 left-1/2 -translate-x-1/2 absolute lg:whitespace-nowrap">
          WELCOME TO GINKINS
        </h2>
        <div></div>
      </div>
