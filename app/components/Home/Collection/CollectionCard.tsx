...
export default function CollectionCard({
  ...
  const showContent = variant !== 'media';

  return (
    <article
      className={
        variant === 'content'
          ? 'collection-card h-full w-full shrink-0 select-none xl:ml-0 lg:ml-35'
          : 'collection-card h-full w-full lg:flex shrink-0 cursor-pointer select-none gap-8 xl:ml-0 lg:ml-35'
      }
    >
      {showMedia && (
