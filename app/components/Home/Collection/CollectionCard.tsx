...
export default function CollectionCard({ title, text, img, alt }: CardProps) {
  return (
    <div className="h-full w-181 lg:flex shrink-0 cursor-pointer">
      ...
      <div className="pb-16.5 flex flex-col gap-13.5 items-start justify-start shrink-0 w-full lg:w-82 relative top-5 lg:top-30">
        ...
        <div className="flex flex-col gap-2.5 items-start justify-start shrink-0 relative -top-7 lg:-top-25 mx-auto lg:mx-0">
