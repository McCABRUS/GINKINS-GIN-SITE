...
export default function CollectionHome() {
  return (
    <section className="relative w-full">
      ...
      <div className="flex flex-col gap-6 items-center justify-start w-full absolute top-[92px]">
        <div className="p-2.5 flex flex-row gap-2.5 items-center justify-center shrink-0 w-[454px] relative">
      ...
      <div className="w-full h-[1269px] static">
        <div
          className="w-[432px] h-[1269px] absolute left-0 top-0"
          style={{
            background:
        ...
        ></div>
        <div
          className="w-[494px] h-[1269px] absolute right-0 top-[64.5%]"
          style={{
            background:
      ...
      <div className="flex flex-col gap-11 w-full absolute ml-[149px] top-[1066px]">
        <div
          className="border-solid border-[#e3d384] border-t -mt-[56px] border-r-[0] border-b-[0] border-l-[0] self-stretch shrink-0 h-0 relative"
          style={{
            transformOrigin: 'top',
        ...
        <div className="flex flex-row gap-[97.64px] items-start justify-center self-stretch shrink-0 h-[216.43px] relative">
          <div className="flex flex-row gap-[51.34px] items-start justify-center flex-1 h-[216.43px] relative">
            <div className="text-colors-whites-100 text-left font-['Barlow-Regular',_sans-serif] text-[16.10613441467285px] leading-[24.16px] font-normal relative flex-1 h-[147.98px]">
            ...
            <div
              className="border-solid border-[#ffffff] border-t-[1px] mt-[108px] border-r-[0] border-b-[0] border-l-[0] shrink-0 w-[216.43px] h-0 relative"
              style={{
                transformOrigin: 'top',
                transform: 'rotate(90deg) scale(1, 1)',
              }}
            ></div>
            <div className="text-colors-whites-100 text-left font-['Barlow-Regular',_sans-serif] text-[16.10613441467285px] leading-[24.16px] font-normal relative flex-1">
