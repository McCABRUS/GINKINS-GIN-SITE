export default function RecipesIntro() {
  return (
    <section className="w-screen bg-(--primary-black) text-background relative overflow-hidden">
      <div className="mx-auto pb-15 md:pb-10 pt-20 lg:py-27 max-xl:px-5 max-4xl:px-37.25 md:max-w-480">
        <div className="grid grid-cols-1 gap-15 md:gap-10 lg:gap-41.25  lg:grid-cols-2 reveal-on-scroll">
          ...
          <div className="space-y-12 reveal-on-scroll-top">
            <p className="text-base leading-6 text-background font-normal mb-15 md:mb-10 lg:mb-15 reveal-on-load-top">
            ...
            <p className="text-3xl md:text-4xl leading-normal text-(--primary-red-200) font-medium italic font-cormorant-garamond reveal-on-load-top">
      ...
      ></div>
      <div className="block lg:hidden absolute border-solid border-background border-t border-r-0 border-b-0 border-l-0 shrink-0 w-[80%] md:w-[94%] lg:w-[80%] h-0 z-20 bottom-0 left-1/2 -translate-x-1/2"></div>
    </section>
  );
}
