  ...
  return (
    <section className="relative w-screen overflow-hidden bg-(--secondary-beige) py-12.75">
      ...
      <div className="relative  text-center">
        <h2 className="mb-6 text-center reveal-on-load-top">Sustainability</h2>
        <h1 className="text-center reveal-on-load-top">The Ginkins Way</h1>
        <div className="my-13.75 lg:my-16 flex justify-center">
          <div className="w-32.75 h-32.75 lg:h-48 lg:w-48 reveal-on-load-center">
            <Image
              draggable={false}
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <h3 className="text-center reveal-on-load-top">
