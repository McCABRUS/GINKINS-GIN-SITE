...
export default function SustainabilityTimeline() {
  return (
    <section className="pb-20 lg:pt-25 bg-(--secondary-beige) max-xl:px-5 max-3xl:px-37.25 md:max-w-480">
      <p className="mx-auto text-3xl lg:text-4xl text-center italic mb-20 lg:mb-27.5 font-cormorant-garamond text-(--primary-black) lg:pb-17.25">
