...
export default function JoinSustainability() {
  return (
    <section className="relative w-full bg-(--primary-gold-main) overflow-hidden py-9 lg:py-20">
      <div className="md:hidden max-xl:px-5 max-3xl:px-37.25 md:max-w-480">
      ...
      <div className="relative z-10 mx-auto flex h-full min-h-130 flex-col items-center justify-center text-center max-xl:px-5 max-3xl:px-37.25 md:max-w-480">
